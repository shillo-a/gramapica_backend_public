...
import _AvatarImage from  "./AvatarImage.js";
...
export default function initModels(sequelize) {
  ...
  var AvatarImage = _AvatarImage.init(sequelize, DataTypes);
  ...
  AuthUser.belongsTo(AvatarImage, { as: "avatar_image", foreignKey: "avatar_image_id"});
  AvatarImage.hasMany(AuthUser, { as: "auth_users", foreignKey: "avatar_image_id"});
