...
import _ArticleGlobalLocation from  "./ArticleGlobalLocation.js";
...
export default function initModels(sequelize) {
  ...
  var ArticleGlobalLocation = _ArticleGlobalLocation.init(sequelize, DataTypes);
  ...
  ArticleGlobalLocation.belongsTo(Article, { as: "article", foreignKey: "article_id"});
  Article.hasMany(ArticleGlobalLocation, { as: "article_global_locations", foreignKey: "article_id"});
  ...
  ArticleGlobalLocation.belongsTo(GlobalLocation, { as: "global_location", foreignKey: "global_location_id"});
  GlobalLocation.hasMany(ArticleGlobalLocation, { as: "article_global_locations", foreignKey: "global_location_id"});
