...
import _ArticleRegion from  "./ArticleRegion.js";
...
import _ArticleTotal from  "./ArticleTotal.js";
...
export default function initModels(sequelize) {
  ...
  var ArticleRegion = _ArticleRegion.init(sequelize, DataTypes);
  ...
  var ArticleTotal = _ArticleTotal.init(sequelize, DataTypes);
  ...
  var Region = _Region.init(sequelize, DataTypes);
  ...
  Article.hasMany(ArticleReview, { as: "article_reviews_FILTER", foreignKey: "article_id"});
  Article.hasMany(ArticleRegion, { as: "article_regions_FILTER", foreignKey: "article_id"});
  // END (double association to include the same model twice)  

  ArticleRegion.belongsTo(Article, { as: "article", foreignKey: "article_id"});
  Article.hasMany(ArticleRegion, { as: "article_regions", foreignKey: "article_id"});
  ...
  ArticleTotal.belongsTo(Article, { as: "article", foreignKey: "article_id"});
  Article.hasMany(ArticleTotal, { as: "article_totals", foreignKey: "article_id"});
  ...
  ArticleRegion.belongsTo(Region, { as: "region", foreignKey: "region_id"});
  Region.hasMany(ArticleRegion, { as: "article_regions", foreignKey: "region_id"});
